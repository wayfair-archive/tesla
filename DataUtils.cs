...
namespace TeslaSQL {
    class DataUtils {
        ...
        public static DataTable GetPendingCTVersions(TServer server, string dbName, Int64 CTID, int syncBitWise) {
        ...
        public static Int64 CreateCTVersion(TServer server, string dbName, Int64 syncStartVersion, Int64 syncStopVersion) {            
        ...
        public static void CreateSlaveCTVersion(TServer server, string dbName, Int64 CTID, string slaveIdentifier,
        ...
        public static void CreateSchemaChangeTable(TServer server, string dbName, Int64 ct_id) {
        ...
        public static void UpdateSyncStopVersion(TServer server, string dbName, Int64 syncStopVersion, Int64 CTID) {
        ...
        */
        ...
        public static bool CheckTableExists(TServer server, string dbName, string table) {
            try {
        ...
        public static string GetIntersectColumnList(TServer server, string dbName, string table1, string table2) {
        ...
        public static bool DropTableIfExists(TServer server, string dbName, string table) {
            try {
                Table t_smo = GetSmoTable(server, dbName, table);
                if (t_smo != null) {
                    t_smo.Drop();
        ...
        public static void CopyDataFromQuery(TServer sourceServer, string sourceDB, TServer destServer, string destDB, SqlCommand cmd, string destinationTable, int queryTimeout = 36000, int bulkCopyTimeout = 36000) {
        ...
        public static void CopyTable(TServer sourceServer, string sourceDB, string table, TServer destServer, string destDB, int timeout) {
        ...
        /// <param name="destServer">Destination server identifier</param>
        /// <param name="destDB">Destination database name</param>    
        public static void CopyTableDefinition(TServer sourceServer, string sourceDB, string table, TServer destServer, string destDB) {
        ...
        public static string ScriptTable(TServer server, string dbName, string table) {
        ...
        public static Dictionary<string, bool> GetFieldList(TServer server, string dbName, string table) {
        ...
        public static void WriteBitWise(TServer server, string dbName, Int64 ct_id, int value, AgentType agentType) {
            string query;
            SqlCommand cmd;
            if (agentType.Equals(AgentType.Slave)) {
        ...
        /// <param name="agentType">Agent type running this request (if it's slave we use tblCTSlaveVersion)</param>
        public static int ReadBitWise(TServer server, string dbName, Int64 ct_id, AgentType agentType) {
            string query;
            SqlCommand cmd;
            if (agentType.Equals(AgentType.Slave)) {
        ...
        public static void MarkBatchComplete(TServer server, string dbName, Int64 ct_id, Int32 syncBitWise, DateTime syncStopTime, AgentType agentType, string slaveIdentifier = "") {
            string query;
            SqlCommand cmd;
            if (agentType.Equals(AgentType.Slave)) {
