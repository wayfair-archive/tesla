...
namespace TeslaSQL.DataCopy {
    public interface IDataCopy {
        ...
        void CopyTable(string sourceDB, string table, string schema, string destDB, int timeout, string destTableName = null, Int64? CTID = null);
        ...
        /// </summary>
        void CopyTableDefinition(string sourceDB, string sourceTableName, string schema, string destDB, string destTableName, Int64? CTID = null);
    }
}
